...
export const SectionTwo = () => {
  const [inputs, setInputs] = useState({
    businessName: '', email: '', location: '', password1: '', password2: '', phoneNumber: ''
  });
  ...
  const handleSubmit = (event) => {
    ...
    if (password !== password2) {
      ...
      const newUser = {
        businessName, email, location, password, phoneNumber
      };
  ...
  <div id="section2" className="section-icon">
    ...
    <article>
      <form onSubmit={handleSubmit}>
        ...
        <Input icon={faUserCircle} type="text" placeholder="Business Name" name="businessName" onChange={handleChange} value={businessName} />
